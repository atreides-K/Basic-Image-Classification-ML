...
def visualize_model(model_config):
    ...
    surf = ax3d.plot_surface(X, Y,loss_surface.T, cmap='viridis', edgecolor='none', vmin=min_loss, vmax=max_loss) # Log scale, transpose Z
    ax3d.set_xlabel('Alpha')
    ax3d.set_ylabel('Beta')
    ax3d.set_zlabel(' Loss')
    ax3d.set_title(f"Loss Landscape: {model_name} ( Scale)")
